...
//                                        System.out.println("content of copied anno endss: ");
                                        ...
                                        //update @id in annotation in annotation list
                                        annoInList.remove("@id");
                                        annoInList.element("@id", copyAnnoNewAID);
                                        result++;
                                    }
                                }
                            }
